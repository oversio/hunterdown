	...
	$("#form-login").validate({
		...
		messages: {
			...
			passwd: {
				...
				minlength: "<span class='merror'>Contraseña debe tener mas de 3 caracteres</span>",
				maxlength: "<span class='merror'>Contraseña no puede exceder los 20 caracteres</span>"
			}
		}
	});
